...
namespace Mawjoud2.Repository
{
    public class GenericRepository<Tbl_Entity> : Repository<Tbl_Entity> where Tbl_Entity : class
    {
        DbSet<Tbl_Entity> _dbSet;

        private Db_MawjoudEntities1 _DBEntity;
       
        public GenericRepository(Db_MawjoudEntities1 DBEntity)
        {
            _DBEntity = DBEntity;
        ...
        public IEnumerable<Tbl_Entity> GetMember()
        {
            return _dbSet.ToList();
        }
        ...
        {
            _dbSet.Attach(entity);
            _DBEntity.Entry(entity).State = EntityState.Deleted;
            _DBEntity.SaveChanges();
        }
